...
public class MyFrame extends JFrame implements ActionListener{
    ...
    MyFrame(){
        ...
        button3.setBounds(100, 0, 100, 50);
        button4.setBounds(200, 0, 100, 50);
        button5.setBounds(300, 0, 100, 50);
        button6.setBounds(400, 0, 100, 50);
        button7.setBounds(500, 0, 100, 50);
        button8.setBounds(600, 0, 100, 50);
